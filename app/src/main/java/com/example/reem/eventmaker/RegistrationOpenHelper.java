...
public class RegistrationOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String DNAME = "D_NAME";
    public static final String DANAME = "DA_NAME";
    public static final String TNAME = "T_NAME";
    public static final String SCRIPT = "create table " + TABLE_NAME + " ("
            + KEY_ID + " integer primary key autoincrement, " + FNAME
            + " text not null, " + DNAME + " text not null,  " + DANAME + " text not null, " + TNAME + " text not null,  " + LNAME + " text not null);";
