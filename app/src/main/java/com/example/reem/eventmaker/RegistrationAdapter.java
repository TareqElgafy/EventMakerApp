...
public class RegistrationAdapter {
    ...
    public long insertDetails(String fname, String dname, String daname, String tname, String lname) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(openHelper_ob.FNAME, fname);
        contentValues.put(openHelper_ob.DNAME, dname);
        contentValues.put(openHelper_ob.DANAME,daname);
        contentValues.put(openHelper_ob.TNAME, tname);
    ...
    public Cursor queryName() {
        String[] cols = { openHelper_ob.KEY_ID, openHelper_ob.FNAME,
                openHelper_ob.LNAME, openHelper_ob.DNAME,openHelper_ob.DANAME, openHelper_ob.TNAME };
        opnToWrite();
    ...
    public long updateldetail(int rowId, String fname, String dname, String daname, String tname, String lname) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(openHelper_ob.FNAME, fname);
        contentValues.put(openHelper_ob.DNAME, dname);
        contentValues.put(openHelper_ob.DANAME,daname);
